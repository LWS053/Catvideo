(function () {
    var h = {},
        mt = {},
        c = {
            id: "adb3aa71d67f562e9968e77648b4008c",
            dm: ["novipnoad.com"],
    ...
    (function () {
            ...
            try {
                ...
                for (var d = a.split(">"), e = document.body, b = d.length - 1; 0 <= b; b--)
                    ...
                    if (!("html" === m || "body" === m)) {
                        ...
                        for (u = 0; u < e.childNodes.length; u++) 1 === e.childNodes[u].nodeType && e.childNodes[u].nodeName.toLowerCase() === m && f.push(e.childNodes[u]);
                        if (!f[b]) return v;
                        e = f[b]
                    }
                    a++
        ...
        mt.f.ta = function (a, d) {
            ...
            for (; a.parentNode != v;) {
                for (var f = 0, m = 0, p = a.parentNode.childNodes.length, u = 0; u < p; u++) {
                    ...
                    if (s.nodeName === a.nodeName && (f++, s === a && (m = f), 0 < m && 1 < f)) break
                }
                if ((p = "" !== a.id) && d) {
                    e.unshift("#" + encodeURIComponent(a.id));
                    break
                } else p && (p = "#" + encodeURIComponent(a.id), p = 0 < e.length ? p + ">" + e.join(">") : p, b.push(p)), e.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < f ? "[" + m + "]" : ""));
                a = a.parentNode
            }
            b.push(e.join(">"));
            return b
        ...
        mt.f.getAttribute = function (a, d) {
            ...
            if (!b && a.attributes && a.attributes.length)
                for (var l = a.attributes, f = l.length, m = 0; m < f; m++) l[m].nodeName === d && (b = l[m].nodeValue);
            return b
        };
        mt.f.R = function (a) {
            var d = "document";
        ...
        (function () {
            (mt.f.Xa = function () {
                ...
                (function () {
                    if (!b)
                        if (b = t, "complete" === document.readyState) a.da = t;
                        else if (document.addEventListener) document.addEventListener("DOMContentLoaded", f, w), window.addEventListener("load", a, w);
                ...
                default:
                    ...
                    if (d instanceof Array) {
                        var e = ["["],
                            l = d.length,
                            f, g, p;
                        for (g = 0; g < l; g++) switch (p = d[g], typeof p) {
                            case "undefined":
                            case "function":
                            case "unknown":
                                break;
                            default:
                                f && e.push(","), e.push(mt.o.stringify(p)), f = 1
                        }
                        e.push("]");
                        return e.join("")
                    }
                    ...
                    g = mt.o.stringify;
                    for (l in d)
                        if (Object.prototype.hasOwnProperty.call(d, l)) switch (p =
                            d[l], typeof p) {
                            case "undefined":
                            case "unknown":
                            case "function":
    ...
    mt.localStorage.set = function (a, b, g) {
        ...
        try {
            window.localStorage ? (b = d.getTime() + "|" + b, window.localStorage.setItem(a, b)) : mt.localStorage.ka() && (mt.localStorage.l.expires = d.toUTCString(), mt.localStorage.l.load(document.location.hostname), mt.localStorage.l.setAttribute(a, b), mt.localStorage.l.save(document.location.hostname))
        } catch (e) {}
    };
    mt.localStorage.get = function (a) {
        ...
        } else if (mt.localStorage.ka()) try {
    ...
    (function () {
        var a = {
            ...
            I: function (a, g) {
                this.D[a] = this.D[a] || [];
                for (var d = this.D[a].length, e = 0; e < d; e++) this.D[a][e](g)
            }
        };
        return h.z = a
    })();
    (function () {
        function a(a, d) {
            ...
            b.d(d, "Function") && (e.readyState ? e.onreadystatechange = function () {
                if ("loaded" === e.readyState || "complete" === e.readyState) e.onreadystatechange = v, d()
            } : e.onload = function () {
                d()
            });
            e.src = a;
            ...
            d = {
                ...
                P: function () {
                    for (var a = document.location.hostname, b = 0, f = c.dm.length; b < f; b++)
                        if (d.V(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[/?#].*/, "");
                    return a
                },
                aa: function () {
                    for (var a = 0, b = c.dm.length; a < b; a++) {
                        var f = c.dm[a];
                        if (-1 < f.indexOf("/") && d.ea(document.location.href, f)) return f.replace(/^[^/]+(\/.*)/, "$1") + "/"
                    }
                    return "/"
                }
            };
            ...
            m = {
                ...
                va: function () {
                    for (var a = {}, b, e = l.length -
                            1; 0 <= e; e--) {
                        b = d[l[e]];
                        for (var q in b) b.hasOwnProperty(q) && (a[q] = b[q])
                    }
                    return a
                },
                ...
                r: function (b) {
                    b !== r && ("userId" ===
                        b && a.d(d.user, "Object") ? (delete d.user.uid_, m.Ca()) : "user" === b && a.d(d.user, "Object") ? (b = d.user.uid_, d.user = b === r ? {} : {
                            uid_: b
                        }, m.Ca()) : d[b] !== r && (d[b] = {}))
                },
                Ca: function () {
                ...
                Pb: function (a, b, e) {
                    var q = t,
                        f = d[a];
                    if (256 < encodeURIComponent(String(b)).length || 256 < encodeURIComponent(String(e)).length) q = w;
                    else {
                        var k = f[b];
                        f[b] = {
                            value: e,
                        ...
                        a = m.M(m.A(a));
                        2048 < encodeURIComponent(a).length && (k !== r ? f[b] = k : delete f[b], q = w)
                    }
                    return q
                },
                M: function (a) {
                    var d = [],
                        b, e;
                    for (e in a) a.hasOwnProperty(e) && (b = [e, a[e].value], (1 === a[e].scope || 2 === a[e].scope) && b.push(a[e].scope), d.push(b.join("*")));
                    return d.join("!")
                },
                Oa: function (a) {
                    a = e[a];
            ...
            var f = {
                ...
                init: function () {
                    for (var a, d = 0; d < c.cptrk.length; d++) try {
                        if (a = g.parse(decodeURIComponent(String(c.cptrk[d]))), a.a !== r && b.d(a.a, "Object")) {
                            var e = a.a,
                                l;
                            for (l in e) e.hasOwnProperty(l) && (f.ha[l] = String(e[l]))
                        }
                    } catch (q) {}
                },
                Ta: function () {
                    var d, b, e;
                    for (e in f.ha)
                        if (f.ha.hasOwnProperty(e) && f.Ua[e] === r && (d = f.ha[e], d = a.ra(d))) b = b === r ? {} : b, b[e] = a.Q(d, w), f.Ua[e] = t;
                    return b
                },
                wa: function () {
                    var a =
                ...
                $: function (a, e) {
                    return function (l) {
                        ...
                        if (f) {
                            ...
                            if (m && m === l) f.removeAttribute(a.ia);
                            else if (e && 0 < e.length && (f = b.Ab(f)) && f.length)
                                if (m = f.length, l = f[f.length - 1], 1E4 > m * l.split(">").length)
                                    for (l = 0; l < m; l++) g.Za(a, f[l]);
                                else g.Za(a, l)
                        }
                    }
                },
                Za: function (d, b) {
                    for (var g = {}, f = String(b).split(">").length, m = 0; m < f; m++) g[b] = "", b = b.substring(0, b.lastIndexOf(">"));
                ...
                cb: function () {
                    if (c.cetrk && c.cetrk.length) {
                        ...
                        for (var d = 0, e = c.cetrk.length; d < e; d++) {
                            ...
                            var k = f.p || ""; - 1 === k.indexOf(">") && (0 === k.indexOf("#") && (k = k.substring(1)), (k = a.Ma(k)) && g.e(k, "click", l.Tb(p, f)))
                        }
                    }
                },
                Ka: function (a) {
        ...
        var a = mt.lang,
            ...
            s = {
                            ...
                            if (f) {
                                ...
                                if (b.getAttribute(f, e.Ha) == v)
                                    if (n) s.la(s.sa(f, d));
                                        ...
                                        var y = b.R(f);
                                        if (a.J(g, "*") || a.J(g, y)) s.la(s.sa(f, d));
                                        else
                                            for (; f.parentNode != v;) {
                                                var n = f.parentNode,
                                                    y = b.R(n),
                ...
                sa: function (f, g) {
                    ...
                    "click" === g.type ? n = d.Ra ? g.clientY +
                        Math.max(document.documentElement.scrollTop, document.body.scrollTop) : g.pageY : "touchend" === g.type && (g.Ba && a.d(g.Ba.changedTouches, "Array") && g.Ba.changedTouches.length) && (n = g.Ba.changedTouches[0].pageY);
                    k.dc = n;
                    return k
                },
                la: function (b) {
                ...
                ma: function (a) {
                    a.length > e.na || (encodeURIComponent(u.join("!") + a).length > e.na && (s.s(u.join("!")), u = []), u.push(a))
                },
                s: function (a) {
                    h.c.b.et = 5;
                    h.c.b.ep = a;
    ...
    (function () {
        var a = mt.event,
            ...
            m = {
                ob: function () {
                    return function () {
                        h.c && (h.c.U && c.aet && c.aet.length) && (window.clearTimeout(f), f = window.setTimeout(function () {
                            m.fb(b.ba() + b.T())
                        }, 150))
                    }
                },
                ...
                ma: function (a) {
                    if (encodeURIComponent(l.join("!") + a).length > g.na || 3 < l.length) m.s(l.join("!")), l = [];
                    l.push(a)
                },
                s: function (a) {
                    h.c.b.et = 6;
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!f || !p) && m && u) k = t, q = +new Date;
            else if (f && p && (!m || !u)) k = w, x += +new Date - q;
            f = m;
            p = u;
            z = setTimeout(b, 100)
        }
        ...
        function d(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) u = "focus" == a.type || "focusin" == a.type ? t : w, b()
        }
        var e = mt.event,
            l = h.z,
            f = t,
        ...
        (function () {
            ...
            "object" == typeof document.onfocusin ? (e.e(document, "focusin", d), e.e(document, "focusout", d)) : (e.e(window, "focus", d),
                e.e(window, "blur", d))
        })();
        h.pa = {
            zb: function () {
    ...
    (function () {
        ...
        var g = mt.url,
            ...
            k = {
                ...
                qb: function () {
                    if (0 < k.W.length)
                        for (var a = 0, b = k.W.length; a < b; a++) k.Da(k.W[a]);
                    k.W =
                        v
                },
                Da: function (a) {
                ...
                _setAutoPageview: function (a) {
                    if (1 < a.length && (a = a[1], w === a || t === a)) k.j |= 2, h.c.Pa = a
                },
                _trackPageview: function (a) {
                    if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                        ...
                        h.c.b.vl = l.ba() + l.T();
                        h.c.b.kb = 0;
                        h.c.xa ? (h.c.b.nv = 0, h.c.b.st = 4) : h.c.xa = t;
                        var b = h.c.b.u,
                            d = h.c.b.su;
                ...
                _trackEvent: function (a) {
                    2 < a.length && (k.j |= 8, h.c.b.nv = 0, h.c.b.st = 4, h.c.b.et = 4, h.c.b.ep = d.h(a[1]) + "*" + d.h(a[2]) + (a[3] ? "*" + d.h(a[3]) : "") + (a[4] ? "*" + d.h(a[4]) : ""), h.c.b.p = x(q.va()), h.c.i(), h.c.b.p = "")
                },
                ...
                _setReferrerOverride: function (a) {
                    1 < a.length && (h.c.b.su = a[1].charAt && "/" === a[1].charAt(0) ? f.protocol + "//" + window.location.host + a[1] : a[1], k.Sa = t)
                },
                _trackOrder: function (a) {
                    a = a[1];
                    d.d(a, "Object") && (b(a), k.j |= 16, h.c.b.nv = 0, h.c.b.st = 4, h.c.b.et = 94, h.c.b.ep = e.stringify(a), h.c.b.p = x(q.va()), h.c.i(), h.c.b.p = "")
                },
                ...
                _setAutoTracking: function (a) {
                    if (1 < a.length && (a = a[1], w === a || t === a)) h.c.Qa = a
                },
                _setAutoEventTracking: function (a) {
                    if (1 < a.length && (a = a[1], w === a || t === a)) h.c.U = a
                },
                ...
                _require: function (a) {
                    1 < a.length && (a = a[1], f.hb.test(g.S(a)) && u(a))
                },
                _providePlugin: function (a) {
                    if (1 <
                        ...
                        var b = window._hmt,
                            e = a[1];
                        a = a[2];
                        if (d.J(f.Va, e) && d.d(a, "Function") && (b.plugins = b.plugins || {}, b.G = b.G || {}, b.plugins[e] = a, b.B = b.B || [], a = b.B.slice(), e && a.length && a[0][1] === e))
                            for (var g = 0, k = a.length; g < k; g++) {
                                var l = a[g][2] || {};
                                if (b.plugins[e] && !b.G[e]) b.G[e] = new b.plugins[e](l), b.B.shift();
                                else break
                            }
                    }
                },
                _requirePlugin: function (a) {
                    if (1 < a.length) {
                        var b = window._hmt,
                            ...
                            g = a[2] || {};
                        if (d.J(f.Va, e))
                            if (b.plugins = b.plugins || {}, b.G = b.G || {}, b.plugins[e] && !b.G[e]) b.G[e] = new b.plugins[e](g);
                            else {
                                b.B = b.B || [];
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = t, this.b = {}, this.Qa = this.Pa = t, this.U = k.U, this.Ja = e.K(c.aet) && 0 < c.aet.length ? c.aet.split(",") : "", this.xa = w, this.init())
        }
        var b = mt.url,
            g = mt.$a,
            d = mt.Ea,
        ...
        a.prototype = {
            ...
            aa: function () {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("/") && this.ea(document.location.href, d)) return d.replace(/^[^/]+(\/.*)/,
                        "$1") + "/"
                }
                return "/"
            },
            Cb: function () {
                ...
                var a = w;
                this.ca(document.referrer) && this.ca(document.location.href) ? a = t : (a = b.S(document.referrer), a = this.V(a || "", document.location.hostname));
            ...
            $b: function () {
                ...
                if (0 === c.nv && this.ca(document.location.href) && ("" === document.referrer || this.ca(document.referrer))) a = 0, b = 4;
                this.b.nv = a;
                this.b.st = b;
                this.b.cc = d;
                this.b.lt = e;
            ...
            init: function () {
                try {
                    this.ac(), 0 === this.b.nv ? this.Yb() : this.La(), h.c = this, this.lb(), this.jb(), y.I("pv-b"), this.Wb()
                } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
            ...
            Wb: function () {
                ...
                this.Pa ? (this.xa =
                    t, this.b.et = 0, this.b.ep = "", this.b.p = x(q.A("pageview")), this.b.vl = f.ba() + f.T(), this.i(a), this.b.p = "") : a();
                this.F = +new Date;
                q.r("pageview")
            },
            i: function (a) {
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.c && (c.med || (!a.Ra || 7 < a.yb()) && c.cvcc)) {
                ...
                s = function (a, g) {
                    ...
                    if (g) {
                        var l = g.getAttribute("href"),
                            ...
                            p = g.getAttribute("id") || "";
                        f.test(l) ? (k.sn =
                            "mediate", k.snv = l) : b.d(m, "String") && f.test(m) && (k.sn = "wrap", k.snv = m);
                        k.id = p
                    }
                    h.c.b.et = 86;
                ...
                m = {
                    click: function () {
                        for (var a = [], b = p(document.getElementsByTagName("a")), b = [].concat.apply(b, p(document.getElementsByTagName("area"))), b = [].concat.apply(b, p(document.getElementsByTagName("img"))), d, e, g, k = 0, l = b.length; k < l; k++) d = b[k], f !== r ? (e = d.getAttribute("onclick"), g = d.getAttribute("href"), q ? (d = d.getAttribute("id"), (f.test(e) ||
                            f.test(g) || q.test(d)) && a.push(b[k])) : (f.test(e) || f.test(g)) && a.push(b[k])) : q !== r && (d = d.getAttribute("id"), q.test(d) && a.push(b[k]));
                        return a
                    }
                }
            }
            if ("undefined" !== typeof m && "undefined" !== typeof f) {
                ...
                l += /\/$/.test(l) ? "" : "/";
                var k = function (a, d) {
                    if (x === d) return s(l + a, d), w;
                    if (b.d(d, "Array") || b.d(d, "NodeList"))
                        for (var e = 0, f = d.length; e < f; e++)
                            if (x === d[e]) return s(l + a + "/" + (e + 1), d[e]), w
                };
    ...
    (function () {
        ...
        if ("undefined" !== typeof h.c && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var e = {
                eb: function () {
                    for (var b = c.cvcf.length, d, m = 0; m < b; m++)(d = a.Ma(decodeURIComponent(c.cvcf[m]))) && g.e(d, "click", e.qa())
                },
                qa: function () {
                    return function () {
                        h.c.b.et = 86;
